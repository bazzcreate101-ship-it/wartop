...
const DEFAULT_DESCRIPTION = 'Wartop adalah tempat top up game, voucher digital, akun ChatGPT, Claude, Gemini, Grok, dan hiburan dengan proses cepat serta pembayaran lengkap.';
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Wartop adalah platform top up game, voucher digital, akun ChatGPT, Claude, Gemini, Grok, dan hiburan untuk pengguna Indonesia.',
            },
          },
          {
            '@type': 'Question',
